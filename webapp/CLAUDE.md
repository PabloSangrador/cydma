...
<styling>
  ...
  <animations>
    ...
    Custom motion components in src/components/motion/:
    - ScrollReveal: Scroll-triggered reveal animations (fade-up, fade-left, fade-right, scale, blur, clip-up, clip-left)
    - StaggerContainer/StaggerItem: Parent-child stagger animations
    - SplitText: Word/character-based text reveal animations
    - Counter: Animated number counting with easing

    Usage:
    ```tsx
    import { ScrollReveal, Counter, SplitText } from "@/components/motion";

    <ScrollReveal variant="fade-up" delay={0.2}>
      <h2>Animated heading</h2>
    </ScrollReveal>

    <Counter from={0} to={500} duration={2} prefix="+" />

    <SplitText as="h1" splitBy="words" stagger={0.04}>
